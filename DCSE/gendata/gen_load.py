...
def gen_load_data(case, case_name, src_dir):
    """
    case: is a modified case file from, e.g. gen_case
    """

    load_active_dir = f"{src_dir}/load/load_active_{case_name}.npy"
    load_reactive_dir = f"{src_dir}/load/load_reactive_{case_name}.npy"
    ...
    if exists(load_active_dir):
        ...
        load_raw_dir = f"{src_dir}/load/load_normalize_clean.csv"
